...
def get_filters():
    ...
    while True:
        city = input("\nWhich city would you like to filter for? (New York City, Chicago or Washington?)\n")
        city = city.title()
    ...
    while True:
        day = input("\nLooking to filter for a specific day? Please select from the following:( Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday or type 'all').\n")
        day = day.title()
